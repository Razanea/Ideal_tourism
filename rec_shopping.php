...
<div class="w3-container w3-content peopleRecom">    
  <!-- The Grid -->
  <div class="w3-row">
...
<!----------------------Filter---------------------------->
 ...
 <?php
             ...
             $query = "SELECT * FROM recommendation WHERE place_type = '  Shooping'";
      ...
      <div class="w3-card w3-round w3-white recomendationCard">
        <div class="w3-container">
         ...
         <hr class="horizontal_line">
          ...
          ?>
          <img src="<?php echo $imageURL; ?>"alt="Riyadh-Park-Mall" class="img2"> 
          <div class="w3-center"> 
           <h3><?php echo $rows['place_name']; ?></h3>
          </div>
          <a href = "<?php echo $rows['place_link']; ?>"
          class = "location w3-small w3-left"><i class="material-icons">location_on</i><?php echo $rows['place_name']; ?></a> 
          <br><p>
         <?php echo $rows['place_msg']; ?>
         </p>
       </div>
    </div>
  </div>
